...
export function RelateSection() {
  return (
    ...
    >
      ...
      >
        Sebelum masuk ke teknis, kenali dulu — berapa kali kamu sudah
        berinteraksi dengan RFID tanpa sadar?
      </p>
      ...
      >
        ...
        <strong style={{ color: '#ffb24d' }}>frekuensi yang berbeda</strong>{' '}
        tergantung kebutuhan jarak dan kecepatan baca. Kita akan bedah
        perbedaannya di bagian berikutnya.
      </div>
    </section>
  );
}
