...
export function WaveSection() {
  ...
  const cfgRef = useRef<WaveCfgRuntime>({
    ...WAVE_CFG['UHF'],
    mode: 'passive',
  });
  ...
  const [phaseLabel, setPhaseLabel] = useState(
    'PASSIVE · Reader memancarkan sinyal ke sekitar',
  );
  ...
  return (
    <section
      ...
      style={{
        position: 'relative',
        padding: isMobile ? '60px 5vw 50px' : '90px 6vw 80px',
        zIndex: 5,
      }}
    >
      <div
      ...
      >
            ...
            <div style={{ position: 'relative', height: 32, margin: '0 2px' }}>
              ...
              <div
                style={{
                  ...
                  right: '8%',
                  height: 1,
                  borderTop: `1px dashed rgba(${isActive ? '57,217,138' : '125,196,240'},.3)`,
              ...
              >
                ...
                <span
                  style={{
                    ...
                    fontSize: 9,
                    letterSpacing: '.1em',
                    color: isActive ? `${GREEN}aa` : '#5d83a3',
                    whiteSpace: 'nowrap',
                    transition: 'color .4s',
                  }}
                >
              ...
              >
                <div
                  style={{
                    width: 1,
                    height: 14,
                    background: isActive ? GREEN : '#7fc4f0',
                    transition: 'background .4s',
                  }}
                />
                <span
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          ...
          <div
            style={{
              background: 'rgba(8,23,38,.6)',
              border: `1px solid ${isActive ? `${GREEN}30` : 'rgba(125,196,240,.15)'}`,
              borderRadius: 6,
              padding: '20px 22px',
              display: 'flex',
              flexDirection: 'column',
          ...
          >
            ...
            <div
              style={{ fontSize: 12, letterSpacing: '.14em', color: '#7fa9c9' }}
            >
              {info.full.toUpperCase()}
            </div>

            <div style={{ display: 'flex', gap: 24, alignItems: 'flex-start' }}>
              <div>
                <div
                  style={{ fontSize: 11, color: '#5d83a3', marginBottom: 4 }}
                >
                  JANGKAUAN
                </div>
                <div
                ...
                <div
                  style={{
                    fontSize: 10,
                    color: isActive ? `${GREEN}80` : '#3d6480',
                    marginTop: 2,
                    letterSpacing: '.08em',
                    transition: 'color .4s',
                  }}
              ...
              <div>
                ...
                <div
                  style={{ fontSize: 17, color: '#7fc4f0', fontWeight: 600 }}
                >
                  {info.wl}
                </div>
              </div>
            ...
            <div
              style={{
                background: isActive ? `${GREEN}0d` : 'rgba(255,178,77,.06)',
                border: `1px solid ${isActive ? `${GREEN}30` : 'rgba(255,178,77,.14)'}`,
                borderRadius: 4,
                padding: '12px 14px',
                transition: 'all .4s',
              }}
      ...
      <div style={{ marginTop: 28 }}>
        ...
        <div
          style={{
            ...
            gap: 1,
            background: isActive ? `${GREEN}22` : 'rgba(125,196,240,.14)',
            border: `1px solid ${isActive ? `${GREEN}33` : 'rgba(125,196,240,.14)'}`,
            borderRadius: 6,
            overflow: 'hidden',
            transition: 'all .4s',
          }}
        >
          {steps.map((s) => (
            <div
              key={s.n}
              style={{ padding: '20px 22px', background: 'rgba(8,18,35,.82)' }}
            >
              <div
                style={{
                  fontFamily: '"IBM Plex Mono",monospace',
              ...
              <div style={{ fontSize: 13, lineHeight: 1.65, color: '#9cbdd1' }}>
                {s.t}
              </div>
            </div>
          ))}
