export function Footer() {
  ...
  return (
    <footer style={{ position: 'relative', margin: '40px 5vw 0', borderTop: '1px solid rgba(125,196,240,.18)', zIndex: 5 }}>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(140px,1fr))' }}>
        {cols.map((c, i) => (
          ...
          >
            ...
            <div style={{ fontSize: 12, color: c.color, wordBreak: 'break-word' }}>{c.value}</div>
          </div>
        ))}
      </div>
      <div style={{ textAlign: 'center', padding: '24px 16px', fontSize: 10, letterSpacing: '.14em', color: '#2f526e' }}>
