...
export const USE_CASES: UseCase[] = [
  ...
  { icon:'ph-books', band:'HF', plan:'library', title:'Perpustakaan', sub:'Manajemen buku',
    desc:'Peminjaman mandiri, inventarisasi rak yang cepat, dan gerbang anti-pencurian.',
    planTitle:'Gerbang perpustakaan', planDesc:'Tumpukan buku melewati gerbang keluar di antara rak; tag HF tiap buku terbaca untuk dicatat.' },
  { icon:'ph-paw-print', band:'LF', plan:'livestock', title:'Hewan & Ternak', sub:'Microchip identitas',
    desc:'Microchip seukuran beras ditanam untuk identifikasi hewan peliharaan dan ternak.',
    planTitle:'Kandang ternak', planDesc:'Tiap hewan mendekati tiang pemindai LF di gerbang kandang dari jarak sangat dekat; microchip-nya langsung terbaca.' },
];
